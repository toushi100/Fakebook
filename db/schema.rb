...
ActiveRecord::Schema[7.0].define(version: 2022_03_31_000012) do
  ...
  create_table "reacts", force: :cascade do |t|
    ...
    t.index ["user_id", "post_id", "comment_id"], name: "index_reacts_on_user_id_and_post_id_and_comment_id", unique: true
